...
//your YQL statement
$yql = "use 'http://thinkphp.ro/apps/YQL/flickr.own.xml' as flickr.own.photos; select * from flickr.own.photos where username='ydn' and amount=20 and size='s' and tags='hack'";
...
<html>
<head>
   <title>Getting a list of Flickr photos by User and Tags with a YQL Open Table</title>
...
<div id="doc2" class="yui-t7">
   ...
   <div id="ft" role="contentinfo"><p>Created by @<a href="http://twitter.com/thinkphp">thinkphp</a> | <a href="getOwnPhotosByTags-with-yql-table.phps">source</a> | <a href="http://thinkphp.ro/apps/YQL/flickr.own.xml">Open Data Table</a> | <?php echo'Time spent: ';echo microtime(true) - $oldtime;echo' seconds';?></p></div>
</div>
</body>
</html>
